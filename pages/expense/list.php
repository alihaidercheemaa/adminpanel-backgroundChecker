                ...
                <div class="app-content">
                    <div class="app-content--inner">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                                    <div class="mx-auto mx-xl-0 mt-3 btn-wrapper">
                                        <a href="/addExpense" class="btn btn-secondary-orio">Add Expense</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card card-box mb-3">
                            ...
                            <table id="expenseList" class="nowrap table table-hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <b class="th-text-iceburk text-uppercase fs-13 Heebo-Regular">Purchase Date</b>
                                        </th>
                                        <th class="text-center">
                                            <b class="th-text-iceburk text-uppercase fs-13 Heebo-Regular">Description</b>
                                        </th>
                                        <th class="text-center">
                                            <b class="th-text-iceburk text-uppercase fs-13 Heebo-Regular">Amount</b>
                                        </th>
                                        <th class="no-sort">
                    ...
                    <script src="<?= BASE_URL ?>/assets/js/app/expense.js?v=<?= time() ?>"></script>