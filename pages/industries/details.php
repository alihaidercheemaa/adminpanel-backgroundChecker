<?php
        ...
        <div class="modal-dialog modal-dialog-centered w-800" role="document">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title mb-3" id="modal-title-default">Add Industry</h6>
                ...
                <div class="modal-body pt-3">
                    <form class="industries_form" id="industries_form" method="post" novalidate>
                        ...
                        <div class="form-group">
                            <a href="javascript: void(0);" class="btn btn-bgchecker" type="button" id="manageIndustryDetails" onclick="manageIndustryDetails(this);" data-module="create">Save</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <!--========================= Add Details =====================-->
    <!--========================= Update Details =====================-->
    <div class="modal fade" id="edit-industry-modal" role="dialog" aria-labelledby="addsucessModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered w-800" role="document">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h6 class="modal-title mb-3" id="modal-title-default">Update Industry</h6>
                    <button type="button" class="close w-100 text-right" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">
                            <svg width="17" height="17" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.5312 2.46875L2.46875 19.5312M2.46875 2.46875L19.5312 19.5312" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div class="modal-body pt-3" id="edit-industry-modal-body">
                ...
                <div class="app-content">
                    <div class="app-content--inner">
                        ...
                        <div class="card card-box mb-3">
                            ...
                            <table id="industryDetailsList" class="nowrap table table-hover" width="100%" industries_id="<?= $id ?>">
                                <thead>
                                    <tr>
                    ...
                    <script src="<?= BASE_URL ?>/assets/js/app/industry_details.js?v=<?= time() ?>"></script>
