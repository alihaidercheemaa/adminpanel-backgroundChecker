                ...
                <div class="app-content">
                    <div class="app-content--inner">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                                    <div class="mx-auto mx-xl-0 mt-3 btn-wrapper">
                                        <a href="/addIndustries" class="btn btn-secondary-orio">Add Industry</a>   
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card card-box mb-3">
                            ...
                            <table id="industriesList" class="nowrap table table-hover" width="100%">
                                <thead>
                                    <tr>
                    ...
                    <script src="<?= BASE_URL ?>/assets/js/app/industries.js?v=<?= time() ?>"></script>