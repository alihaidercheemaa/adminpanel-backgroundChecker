                ...
                <div class="app-content">
                    <div class="app-content--inner">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 d-flex align-items-center justify-content-start mt-xl-0 justify-content-xl-end">
                                    <div class="mx-auto mx-xl-0 mt-3 btn-wrapper">
                                        <a href="/addBlogs" class="btn btn-secondary-orio">Add Blogs</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card card-box mb-3">
                            ...
                            <table id="blogsList" class="nowrap table table-hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <b class="th-text-iceburk text-uppercase fs-13 Heebo-Regular">Author</b>
                                        </th>
                                        <th class="text-center">
                    ...
                    <script src="<?= BASE_URL ?>/assets/js/app/blogs.js?v=<?= time() ?>"></script>