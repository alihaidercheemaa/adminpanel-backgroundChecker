<?php
    ...
    $url = API_URL . "blogs/details";
    $request = ["slug" => (string)$slug];
                                                ...
                                                <div class="dropzone dropzone-single dz-clickable dz-max-files-reached" data-toggle="dropzone-image-1" data-dropzone-url="/assets/uploads/upload" data-max-filesizee="1024x1024">
                                                    ...
                                                    <div class="dz-preview dz-preview-single">
                                                        <div class="dz-preview-cover">
                                                            <img class="dz-preview-img" src="/assets/uploads/<?= $details->blog_image; ?>" alt="..." data-dz-thumbnail>
                                                        </div>
                                                    </div>
                                                    <div id="dropzone_upload" style="z-index:0" class="dropzone_upload">
                                                        <img src="/assets/uploads/<?= $details->blog_image; ?>">
                                                    </div>
                                                </div>
                                                <input type="hidden" value="<?= $details->blog_image; ?>" class="image" id="image-1">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="author" id="author" class="form-control" required placeholder="Author" value="<?= $details->author ?>" maxlength="100">
                                            </div>
                                            <div class="form-group">
                                                <label>Date <span class="text-danger">*</span></label>
                                                <input class="form-control form-control-lg" id="date" data-toggle="datepicker" placeholder="Select date" type="text" autocomplete="off" required value="<?= date('d-m-Y', strtotime($details->blog_date)) ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Short Description <span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="short_content" id="short_content" placeholder="Type your Blog short description here..." required rows="4" cols="80"><?= $details->short_description ?></textarea> 
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Detailed Description <span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="detailed_content" id="detailed_content" placeholder="Type your Blog detailed description here..." required data-ckeditor rows="10" cols="80"><?= $details->detailed_description ?></textarea>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <a href="javascript: void(0);" class="btn btn-bgchecker" type="button" id="manageBlogs" onclick="manageBlogs();" data-module="update" blogs_id="<?= $details->id ?>">Save</a>
                                    </div>
                                </form>
                            </div>
                        </div>
