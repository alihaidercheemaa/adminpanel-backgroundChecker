    ...
    <div class="app-wrapper">
        ...
        <div class="app-main">
            ...
            <div class="app-content">
                    ...
                    <div class="card card-box mb-3">
                        ...
                        <section class="py-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        <label class="modal-lable form-label">Credibility Image</label>
                                    </div>
                                    <div class="dropzone dropzone-single dz-clickable" data-toggle="dropzone-image-1" data-dropzone-url="/assets/uploads/upload" data-max-filesizee="800x503">
                                        <div class="fallback">
                            ...
                            <div class="col-md-12 text-start">
                                <a href="javascript: void(0);" class="btn btn-bgchecker" onclick="manageCredibility()">Upload</a>
                            </div>
                        </section>
                        <hr>

                        <table id="credibilityList" class="nowrap table table-hover" width="100%">
                            <thead>
                                <tr>
                ...
                <script src="<?= BASE_URL ?>/assets/js/app/credibility.js?v=<?= time() ?>"></script>
