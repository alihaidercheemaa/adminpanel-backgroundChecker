...
<body id="app-top">
    <div class="app-wrapper">
        ...
        <div class="app-main">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="Type your Service short description here..." required rows="4" cols="80" maxlength="200"><?= $details->description ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <a href="javascript: void(0);" class="btn btn-bgchecker" type="button" id="manageServices" onclick="manageServices();" data-module="update" services_id="<?= $details->id ?>">Save</a>
                                </div>
                            </form>
                    </div>
                </div>
            ...
            <script type="text/javascript" src="<?= BASE_URL ?>/assets/js/app/services.js?v=<?= time() ?>"></script>
