        ...
        case 'industriesList':
            ...
            if ($response->status == 1 && count($response->payload) > 0) {
                foreach ($response->payload as $item) {
                    ...
                    $action = ($status == '1') 
                    ?'
                    <a href="/industryDetails?id=' . $id . '" id="row_' . $id . '" data-toggle="tooltip" data-original-title="Details"><img src="' . BASE_URL . '/assets/images/svg/view.svg" width="20" alt="Add Dtails"></a>
                    <a href="/updateIndustries?id=' . $id . '" id="row_' . $id . '" data-toggle="tooltip" data-original-title="Edit"><img src="' . BASE_URL . '/assets/images/svg/edit.svg" width="15" alt="Edit"></a>'
                     : '';
                    ;
                    $data[] = [
                        'sno' => $i,
