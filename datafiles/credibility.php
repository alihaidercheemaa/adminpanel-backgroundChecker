<?php
    ...
    extract($_REQUEST);
    switch ($requestType) {
        case 'manageCredibility':
            $request = [
                "image" => $image
            ];
            $url = API_URL . "credibility/create";
            ...
            exit();
            break;
        case 'credibilityList':
            $url = API_URL . "credibility/list";
        ...
        case 'deleteRecord':
            $url = API_URL . "credibility/delete";
            $request = ["id" => (int) $id];
            ...
            break;
        case 'updateStatus':
            $url = API_URL . "credibility/status";
